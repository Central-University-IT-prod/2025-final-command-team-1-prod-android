package ru.prod.application.auth.presentation.screens.signUpScreen
...
fun SignUpScreenView(
    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Row {
                Text(
                    text = stringResource(id = R.string.to_login_screen_first_part),
                    style = MaterialTheme.typography.labelSmall,
                    color = colorResource(id = R.color.secondary_text)
                )
                ...
                Text(
                    text = stringResource(id = R.string.to_login_screen_second_part),
                    style = MaterialTheme.typography.labelSmall,
                    color = colorResource(id = R.color.base),
                    modifier = Modifier.clickable(onClick = navigateToLoginScreen)
                )
            }
        }
    }
